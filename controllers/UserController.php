...
class UserController extends DefaultController {
    ...
    //         require(APP_NON_WEB_BASE_DIR .'views/loginReg.php');
    //     }else{
    //         $sanitized_userEmail = userEmailPOST($_POST['userEmail']);
    //         //query database for account matching userEmail
    ...
    //         }else{
    //             $delay = true;
    //             $logErr[] = "password or userEmail incorrect";
    //             require(APP_NON_WEB_BASE_DIR . 'views/loginReg.php');
    //         }
    //         //validations
    //         //save to session?
    ...
    public function registerPOST() {
        ...
        $valid = true;
        $regErr = [];
        if(!isset($_POST['userEmail']) || !isset($_POST['password']) || !isset($_POST['firstName']) || !isset($_POST['lastName'])){
        ...
        if(strpos($_POST['userEmail'],';')!==false || strpos($_POST['userEmail'],'\'')!==false
